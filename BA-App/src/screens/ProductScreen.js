...
import { Search, Filter, ArrowUpAz, ArrowDownAz, ArrowUp10, ArrowDown10, X } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.sortRow}>
            <TouchableOpacity onPress={() => setSortBy('name-asc')} style={[styles.sortBtn, sortBy === 'name-asc' && styles.sortBtnActive]}>
                <ArrowUpAz size={16} color={sortBy === 'name-asc' ? 'white' : 'gray'} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setSortBy('name-desc')} style={[styles.sortBtn, sortBy === 'name-desc' && styles.sortBtnActive]}>
                <ArrowDownAz size={16} color={sortBy === 'name-desc' ? 'white' : 'gray'} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setSortBy('price-asc')} style={[styles.sortBtn, sortBy === 'price-asc' && styles.sortBtnActive]}>
                <ArrowUp10 size={16} color={sortBy === 'price-asc' ? 'white' : 'gray'} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setSortBy('price-desc')} style={[styles.sortBtn, sortBy === 'price-desc' && styles.sortBtnActive]}>
                <ArrowDown10 size={16} color={sortBy === 'price-desc' ? 'white' : 'gray'} />
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  sortBtn: { padding: 8, borderRadius: 8, backgroundColor: Colors.gray, marginRight: 8 },
