...
const ProductDetailsScreen = ({ route, navigation }) => {
  ...
  if (!product) return <View style={styles.center}><Text>Product niet gevonden</Text></View>;
...
const styles = StyleSheet.create({
  ...
  price: { fontSize: 22, fontWeight: 'bold', color: Colors.primary, marginBottom: 20 },
  sectionTitle: { fontSize: 16, fontWeight: 'bold', marginBottom: 8 },
  description: { color: '#666', lineHeight: 22, marginBottom: 24 },
  quantitySection: { marginBottom: 24 },
  quantityControls: { flexDirection: 'row', alignItems: 'center' },
  qtyBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: Colors.gray, justifyContent: 'center', alignItems: 'center' },
  qtyText: { marginHorizontal: 20, fontSize: 18, fontWeight: 'bold' },
  totalSection: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 20, borderTopWidth: 1, borderTopColor: '#eee' },
  totalLabel: { fontSize: 18, fontWeight: 'bold' },
  totalPrice: { fontSize: 22, fontWeight: 'bold', color: Colors.primary },
  buyButton: { backgroundColor: Colors.primary, padding: 18, borderRadius: 12, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' },
